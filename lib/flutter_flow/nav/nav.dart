...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'FogotPassword',
          path: '/fogotPassword',
          builder: (context, params) => const FogotPasswordWidget(),
        ),
        FFRoute(
          name: 'EditProfile',
          path: '/editProfile',
        ...
        FFRoute(
          ...
          builder: (context, params) => const DiseaseDetectionWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'DiagnosesList',
          path: '/diagnosesList',
          builder: (context, params) => const DiagnosesListWidget(),
        ),
        FFRoute(
          name: 'DiagnoseDetail',
          path: '/diagnoseDetail',
          builder: (context, params) => DiagnoseDetailWidget(
            diagnoseDocRef: params.getParam(
              'diagnoseDocRef',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['diagnoses'],
            ),
          ),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'DiseasesDetectCopy',
          path: '/diseasesDetectCopy',
          builder: (context, params) => DiseasesDetectCopyWidget(
            isCamera: params.getParam(
              'isCamera',
              ParamType.bool,
            ),
          ),
        ...
        FFRoute(
          name: 'VideoPromptPage',
          path: '/videoPromptPage',
          builder: (context, params) => const VideoPromptPageWidget(),
        ),
        FFRoute(
