                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    Container(
                                                      ...
                                                      child: Image.asset(
                                                        'assets/images/ai_chat_image1.png',
                                                        fit: BoxFit.fill,
                                                      ),
                                                    ),
                                                  ],
                                  ...
                                  Expanded(
                                    child: TextFormField(
                                      ...
                                      onChanged: (_) => EasyDebounce.debounce(
                                        ...
                                        () async {
                                          setState(() {
                                            _model.isTextFieldEmpty = functions
                                                .isTextFieldEmpty(_model
                                                    .chatInputTextController
                                                    .text);
                                          });
                                        },
                                      ),
                                    ...
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        ...
                                        await geminiGenerateText(
                                          context,
                                          '${_model.userQuery}. Please provide the response in markdown text format. convert into language code ${FFAppState().selectedLanguageCode}. Provide Response in 800 characters only. ',
                                        ).then((generatedText) {
                                          safeSetState(() =>
                                        ...
                                        _model.audioOutput =
                                            await BuildshipAPIsGroup
                                                .textToAudioCall
                                                .call(
                                          text:
                                              functions.removeSpecialCharacters(
                                                  _model.geminiResponse!),
                                        );
